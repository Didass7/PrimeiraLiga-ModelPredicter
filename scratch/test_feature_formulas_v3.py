...
for idx, row in df.iterrows():
    ...
    # Check if they have played games previously (continuous chronological)
    ...
    if len(h_scored) == 0 or len(a_conceded) == 0:
        # Fallback to historical averages from previous season or defaults
...
print("\nExpected Goals Verification (continuous carry-over):")
